...
export async function SiteHeader() {
  ...
  return (
    <header className="border-b border-[var(--line)]">
      <div className="mx-auto flex w-full max-w-[1480px] items-center justify-between gap-3 px-5 py-3.5 md:gap-4 md:px-8 md:py-4 lg:grid lg:grid-cols-[minmax(272px,386px)_minmax(0,1fr)] lg:items-center lg:gap-7 lg:px-10 xl:grid-cols-[minmax(318px,430px)_minmax(0,1fr)] xl:gap-8 2xl:grid-cols-[minmax(332px,448px)_minmax(0,1fr)] 2xl:px-12">
        <Link
          href="/"
          className="min-w-0 flex-1 max-w-[286px] md:max-w-[354px] lg:w-full lg:max-w-[386px] xl:max-w-[430px] 2xl:max-w-[448px]"
